...
//    private static final String DB_PATH = "E:\\neo4j\\data\\neo4jDatabases\\database-75a2865c-6ae2-4103-b8b6-8036255890f8\\installation-3.5.14\\data\\databases\\graph.db";
//
...
//        Transaction tx = graphDB.beginTx();
//
//        ResourceIterator<Node> iterator = graphDB.findNodes(new CaseLabel("政策"));
//        for (ResourceIterator<Node> it = iterator; it.hasNext(); ) {
//            Node node = it.next();
//            long id = node.getId();
//            String name = (String)node.getProperty("policyname");
//            String idcard = (String)node.getProperty("policyid");
//           // String tel = (String)node.getProperty("tel");
//
