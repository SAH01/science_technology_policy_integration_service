...
(function ($) {
    ...
    $.fn.menu.parseOptions = function (_476) {
        return $.extend({}, $.parser.parseOptions(_476, [{
            minWidth: "number",
            itemHeight: "number",
            duration: "number",
    ...
    $.fn.menu.defaults = {
        ...
        position: function (_477, left, top) {
            return {left: left, top: top};
        },
        onShow: function () {
        },
...
(function ($) {
    ...
    $.fn.menubutton.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "menubutton").options, {
                toggle: _489.toggle,
                selected: _489.selected,
                disabled: _489.disabled
            });
        }, destroy: function (jq) {
            return jq.each(function () {
    ...
    $.fn.menubutton.parseOptions = function (_48a) {
        var t = $(_48a);
        return $.extend({}, $.fn.linkbutton.parseOptions(_48a), $.parser.parseOptions(_48a, ["menu", {
            plain: "boolean",
...
(function ($) {
    ...
    $.fn.splitbutton.parseOptions = function (_492) {
        var t = $(_492);
        return $.extend({}, $.fn.linkbutton.parseOptions(_492), $.parser.parseOptions(_492, ["menu", {
            plain: "boolean",
            duration: "number"
        }]));
    };
...
(function ($) {
    ...
    function _496(_497, _498) {
        ...
        _49a.find(".switchbutton-on").css({
            width: (w - _49c / 2) + "px",
            textIndent: (opts.reversed ? "" : "-") + _49c / 2 + "px"
        });
        _49a.find(".switchbutton-off").css({
            width: (w - _49c / 2) + "px",
            textIndent: (opts.reversed ? "-" : "") + _49c / 2 + "px"
        });
    ...
    $.fn.switchbutton = function (_4b9, _4ba) {
        ...
        return this.each(function () {
            ...
            if (_4bb) {
                ...
                _4bb = $.data(this, "switchbutton", {
                    options: $.extend({}, $.fn.switchbutton.defaults, $.fn.switchbutton.parseOptions(this), _4b9),
    ...
    $.fn.switchbutton.parseOptions = function (_4bf) {
        var t = $(_4bf);
        return $.extend({}, $.parser.parseOptions(_4bf, ["onText", "offText", "handleText", {
            handleWidth: "number",
            reversed: "boolean"
        }]), {
...
(function ($) {
    ...
    $.fn.validatebox.parseOptions = function (_4f1) {
        var t = $(_4f1);
        return $.extend({}, $.parser.parseOptions(_4f1, ["validType", "missingMessage", "invalidMessage", "tipPosition", {
            delay: "number",
            interval: "number",
            deltaX: "number"
        }, {
    ...
    $.fn.validatebox.defaults = {
        ...
        events: {
            focus: _4c8, blur: _4cc, mouseenter: _4cf, mouseleave: _4d2, click: function (e) {
                var t = $(e.data.target);
...
(function ($) {
    ...
    function _50a(_50b, _50c) {
        ...
        _510.css({
            paddingLeft: (_50b.style.paddingLeft || ""),
            paddingRight: (_50b.style.paddingRight || ""),
            marginLeft: _516("left"),
            marginRight: _516("right"),
            marginTop: _514("top"),
            marginBottom: _514("bottom")
        });
        if (opts.multiline) {
    ...
    function _504(_519) {
        ...
        _51a.validatebox($.extend({}, opts, {
            deltaX: function (_51b) {
    ...
    $.fn.textbox = function (_52e, _52f) {
        ...
        return this.each(function () {
            ...
            if (_532) {
                ...
                _532 = $.data(this, "textbox", {
                    options: $.extend({}, $.fn.textbox.defaults, $.fn.textbox.parseOptions(this), _52e),
                    textbox: init(this)
                });
    ...
    $.fn.textbox.parseOptions = function (_54d) {
        var t = $(_54d);
        return $.extend({}, $.fn.validatebox.parseOptions(_54d), $.parser.parseOptions(_54d, ["prompt", "iconCls", "iconAlign", "buttonText", "buttonIcon", "buttonAlign", "label", "labelPosition", "labelAlign", {
            multiline: "boolean",
            iconWidth: "number",
            labelWidth: "number"
...
(function ($) {
    ...
    $.fn.passwordbox.parseOptions = function (_56d) {
        return $.extend({}, $.fn.textbox.parseOptions(_56d), $.parser.parseOptions(_56d, ["passwordChar", {
    ...
    $.fn.passwordbox.defaults = $.extend({}, $.fn.textbox.defaults, {
        ...
        revealed: false,
        showEye: true,
        inputEvents: {focus: _561, blur: _565},
        val: function (_56e) {
...
(function ($) {
    function _5a7(_5a8) {
        ...
        function _5ae(item) {
            ...
            $(_5a8).textbox("button").menubutton({
                text: item.text,
...
(function ($) {
    ...
    function load(_5d0, data) {
        ...
        if (typeof data == "string") {
            ...
            $.ajax({
                url: data, data: _5d1, dataType: "json", success: function (data) {
                    _5d2(data);
                }, error: function () {
    ...
    $.fn.form.parseOptions = function (_5ef) {
        var t = $(_5ef);
        return $.extend({}, $.parser.parseOptions(_5ef, [{
            ajax: "boolean",
            dirty: "boolean"
...
(function ($) {
    ...
    $.fn.numberbox.parseOptions = function (_603) {
        var t = $(_603);
        return $.extend({}, $.fn.textbox.parseOptions(_603), $.parser.parseOptions(_603, ["decimalSeparator", "groupSeparator", "suffix", {
            min: "number",
            max: "number",
            precision: "number"
...
(function ($) {
    ...
    $.fn.calendar.parseOptions = function (_635) {
        var t = $(_635);
        return $.extend({}, $.parser.parseOptions(_635, ["weekNumberHeader", {
            firstDay: "number",
            fit: "boolean",
            border: "boolean",
            showWeek: "boolean"
...
(function ($) {
    function _63a(_63b) {
        ...
        $(_63b).addClass("spinner-f").textbox($.extend({}, opts, {
            icons: _63d, doSize: false, onResize: function (_63f, _640) {
                if (!opts.spinArrow) {
                    var span = $(this).next();
    ...
    $.fn.spinner.parseOptions = function (_64e) {
        return $.extend({}, $.fn.textbox.parseOptions(_64e), $.parser.parseOptions(_64e, ["min", "max", "spinAlign", {
            increment: "number",
            reversed: "boolean"
        }]));
    };
...
(function ($) {
    ...
    $.fn.timespinner.parseOptions = function (_66e) {
        return $.extend({}, $.fn.spinner.parseOptions(_66e), $.parser.parseOptions(_66e, ["separator", {
            showSeconds: "boolean",
            highlight: "number"
        }]));
    };
...
(function ($) {
    ...
    function _695(_696) {
        ...
        _69a.add(_69b).children("div.datagrid-body").css({
            marginTop: _6a1,
            height: (isNaN(parseInt(opts.height)) ? "" : (_699 - _6a2)),
            minHeight: (_6a4 ? _6a4 - _6a3 - _6a2 : ""),
            maxHeight: (_6a5 ? _6a5 - _6a3 - _6a2 : "")
        });
    ...
    function _6ba(_6bb, _6bc) {
        ...
        return {
            ...
            dc: {
                ...
                view1: _6c1,
                view2: _6c2,
                header1: _6c1.children("div.datagrid-header").children("div.datagrid-header-inner"),
                header2: _6c2.children("div.datagrid-header").children("div.datagrid-header-inner"),
                body1: _6c1.children("div.datagrid-body").children("div.datagrid-body-inner"),
                body2: _6c2.children("div.datagrid-body"),
                footer1: _6c1.children("div.datagrid-footer").children("div.datagrid-footer-inner"),
                footer2: _6c2.children("div.datagrid-footer").children("div.datagrid-footer-inner")
            }
        };
    };
    ...
    function _6c3(_6c4) {
        ...
        _6c6.panel($.extend({}, opts, {
            id: null, doSize: false, onResize: function (_6c7, _6c8) {
        ...
        if (opts.pagination) {
            ...
            _6cb.pagination({
                ...
                onSelectPage: function (_6cc, _6cd) {
            ...
            if (col && col.editor) {
                ...
                if (_7c3) {
                    ...
                    $.data(cell[0], "datagrid.editor", {
                        actions: _7c3,
                        target: _7c3.init(cell.find("td"), $.extend({height: opts.editorHeight}, _7c2)),
                        field: _7c0,
                        type: _7c1,
                        oldHtml: _7c4
                    });
    ...
    var _813 = $.extend({}, _805(["text", "textbox", "passwordbox", "filebox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "combotreegrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
            init: function (_814, _815) {
    ...
    $.fn.datagrid.methods = {
        options: function (jq) {
            ...
            var opts = $.extend(_82c, {
                width: _82d.width,
                height: _82d.height,
                closed: _82d.closed,
                collapsed: _82d.collapsed,
                minimized: _82d.minimized,
                maximized: _82d.maximized
            });
            return opts;
    ...
    $.fn.datagrid.parseOptions = function (_859) {
        var t = $(_859);
        return $.extend({}, $.fn.panel.parseOptions(_859), $.parser.parseOptions(_859, ["url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition", "resizeHandle", {
    ...
    var _85c = {
        render: function (_85d, _85e, _85f) {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        rownumberWidth: 30,
        editorHeight: 24,
        headerEvents: {mouseover: _6e4(true), mouseout: _6e4(false), click: _6e8, dblclick: _6ed, contextmenu: _6f0},
        rowEvents: {mouseover: _6f2(true), mouseout: _6f2(false), click: _6f9, dblclick: _703, contextmenu: _707},
        rowStyler: function (_8a2, _8a3) {
        },
        loader: function (_8a4, _8a5, _8a6) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _8a4, dataType: "json", success: function (data) {
                    _8a5(data);
                }, error: function () {
        ...
        editors: _813,
        finder: {
            getTr: function (_8a7, _8a8, type, _8a9) {
                type = type || "body";
                _8a9 = _8a9 || 0;
...
(function ($) {
    ...
    function _8de(_8df) {
        ...
        $(_8df).datagrid($.extend({}, opts, {
            cls: "propertygrid",
            view: (opts.showGroup ? opts.groupView : opts.view),
            onBeforeEdit: function (_8e1, row) {
    ...
    var _8ed = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_8ee, _8ef, _8f0) {
            var _8f1 = [];
    ...
    $.extend(_8ed, {
        refreshGroupTitle: function (_914, _915) {
    ...
    $.fn.propertygrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        groupView: _8ed,
        groupField: "group",
        groupFormatter: function (_92e, rows) {
            return _92e;
        }
    });
})(jQuery);
(function ($) {
    function _92f(_930) {
        ...
        if (opts.pagination) {
            ...
            _93c.pagination({
                ...
                pageSize: opts.pageSize,
                pageList: opts.pageList,
                onSelectPage: function (_93d, _93e) {
    ...
    $.fn.treegrid = function (_9c4, _9c5) {
        ...
        return this.each(function () {
            ...
            if (_9c7) {
                ...
                _9c7 = $.data(this, "treegrid", {
                    options: $.extend({}, $.fn.treegrid.defaults, $.fn.treegrid.parseOptions(this), _9c4),
                    data: [],
                    checkedRows: [],
                    tmpIds: []
                });
    ...
    $.fn.treegrid.parseOptions = function (_9d3) {
        return $.extend({}, $.fn.datagrid.parseOptions(_9d3), $.parser.parseOptions(_9d3, ["treeField", {
            checkbox: "boolean",
            cascadeCheck: "boolean",
            onlyLeafCheck: "boolean"
        }, {animate: "boolean"}]));
    };
    var _9d4 = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_9d5, _9d6, _9d7) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        loader: function (_a12, _a13, _a14) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
            $.ajax({
                type: opts.method, url: opts.url, data: _a12, dataType: "json", success: function (data) {
                    _a13(data);
                }, error: function () {
        ...
        finder: {
            getTr: function (_a16, id, type, _a17) {
                type = type || "body";
                _a17 = _a17 || 0;
...
(function ($) {
    function _a20(_a21) {
        ...
        $(_a21).datagrid($.extend({}, opts, {
            ...
            columns: (opts.columns && opts.columns.length) ? opts.columns : [[{
                field: opts.textField, width: "100%", formatter: function (_a22, row, _a23) {
                    return opts.textFormatter ? opts.textFormatter(_a22, row, _a23) : _a22;
                }
            }]]
        }));
    };
    var _a24 = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_a25, _a26, _a27) {
    ...
    $.fn.datalist.parseOptions = function (_a3d) {
        return $.extend({}, $.fn.datagrid.parseOptions(_a3d), $.parser.parseOptions(_a3d, ["valueField", "textField", "groupField", {
            checkbox: "boolean",
            lines: "boolean"
        }]));
    };
    ...
    $.fn.datalist.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        groupField: "",
        view: _a24,
        textFormatter: function (_a40, row) {
            return _a40;
        },
...
(function ($) {
    ...
    function _a43(_a44) {
        ...
        $(_a44).addClass("combo-f").textbox($.extend({}, opts, {
            icons: _a4a, onChange: function () {
            }
        }));
    ...
    function _a5f(_a60) {
        ...
        if (_a64.closed) {
            _a63.panel("panel").show().css({
                zIndex: ($.fn.menu ? $.fn.menu.defaults.zIndex++ : ($.fn.window ? $.fn.window.defaults.zIndex++ : 99)),
                left: -999999
            });
            _a63.panel("resize", {
                width: (opts.panelWidth ? opts.panelWidth : _a62._outerWidth()),
    ...
    $.fn.combo = function (_a85, _a86) {
        ...
        return this.each(function () {
            ...
            if (_a88) {
                ...
                _a88 = $.data(this, "combo", {
                    options: $.extend({}, $.fn.combo.defaults, $.fn.combo.parseOptions(this), _a85),
                    previousText: ""
                });
    ...
    $.fn.combo.parseOptions = function (_a8b) {
        var t = $(_a8b);
        return $.extend({}, $.fn.textbox.parseOptions(_a8b), $.parser.parseOptions(_a8b, ["separator", "panelAlign", {
            panelWidth: "number",
            hasDownArrow: "boolean",
            delay: "number",
            reversed: "boolean",
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: {click: _a55, keydown: _a59, paste: _a59, drop: _a59, blur: _a5c},
        panelEvents: {
...
(function ($) {
    ...
    $.fn.combobox = function (_acf, _ad0) {
        ...
        return this.each(function () {
            ...
            if (_ad2) {
                ...
                _ad2 = $.data(this, "combobox", {
                    options: $.extend({}, $.fn.combobox.defaults, $.fn.combobox.parseOptions(this), _acf),
                    data: []
                });
            }
            _ac1(this);
    ...
    $.fn.combobox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "combobox").options, {
                width: _ad3.width,
                height: _ad3.height,
                originalValue: _ad3.originalValue,
                disabled: _ad3.disabled,
                readonly: _ad3.readonly
            });
        }, cloneFrom: function (jq, from) {
            return jq.each(function () {
    ...
    $.fn.combobox.parseOptions = function (_ada) {
        var t = $(_ada);
        return $.extend({}, $.fn.combo.parseOptions(_ada), $.parser.parseOptions(_ada, ["valueField", "textField", "groupField", "groupPosition", "mode", "method", "url", {
    ...
    var _adf = 0;
    var _ae0 = {
        render: function (_ae1, _ae2, data) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        ...
        panelEvents: {
            mouseover: _ac4, mouseout: _ac5, mousedown: function (e) {
                e.preventDefault();
                e.stopPropagation();
            }, click: _ac6, scroll: _ac9
        },
        ...
        loader: function (_ae9, _aea, _aeb) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _ae9, dataType: "json", success: function (data) {
                    _aea(data);
                }, error: function () {
    ...
    $.fn.combotree.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "combotree").options, {
                width: _b1d.width,
                height: _b1d.height,
                originalValue: _b1d.originalValue,
                disabled: _b1d.disabled,
                readonly: _b1d.readonly
            });
...
(function ($) {
    function _b23(_b24) {
        ...
        var grid = _b25.grid;
        $(_b24).addClass("combogrid-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                ...
                dg.datagrid("resize", {
                    ...
                    minHeight: (_b27 ? _b27 - _b26 : ""),
                    maxHeight: (_b28 ? _b28 - _b26 : "")
                });
        ...
        grid.datagrid($.extend({}, opts, {
            ...
            onLoadSuccess: _b2a,
            onClickRow: _b2b,
            onSelect: _b2c("onSelect"),
            onUnselect: _b2c("onUnselect"),
            onSelectAll: _b2c("onSelectAll"),
            onUnselectAll: _b2c("onUnselectAll")
        }));
...
(function ($) {
    function _b65(_b66) {
        ...
        $(_b66).addClass("combotreegrid-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                ...
                dg.treegrid("resize", {
                    width: "100%",
                    height: (isNaN(parseInt(opts.panelHeight)) ? "auto" : "100%"),
                    minHeight: (_b69 ? _b69 - _b68 : ""),
                    maxHeight: (_b6a ? _b6a - _b68 : "")
                });
        ...
        _b67.grid.treegrid($.extend({}, opts, {
    ...
    $.fn.combotreegrid.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "combotreegrid").options, {
                width: _b86.width,
                height: _b86.height,
                originalValue: _b86.originalValue,
                disabled: _b86.disabled,
                readonly: _b86.readonly
            });
        }, grid: function (jq) {
...
(function ($) {
    function _b8c(_b8d) {
        ...
        $(_b8d).addClass("tagbox-f").combobox($.extend({}, opts, {
            cls: "tagbox", reversed: true, onChange: function (_b8f, _b90) {
                _b91();
    ...
    function _ba7(_ba8) {
        ...
        tmp.css({
            ...
            left: -9999,
            width: "auto",
            fontFamily: _ba9.css("fontFamily"),
            fontSize: _ba9.css("fontSize"),
            fontWeight: _ba9.css("fontWeight"),
            whiteSpace: "nowrap"
        });
    ...
    $.fn.tagbox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "tagbox").options, {
                width: _bba.width,
                height: _bba.height,
                originalValue: _bba.originalValue,
                disabled: _bba.disabled,
                readonly: _bba.readonly
            });
...
(function ($) {
    function _bc4(_bc5) {
        ...
        $(_bc5).addClass("datebox-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                _bc7(this);
                _bc8(this);
                _bc9(this);
        ...
        if (!_bc6.calendar) {
            ...
            $.extend(_bc6.calendar.calendar("options"), {
    ...
    $.fn.datebox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "datebox").options, {
                width: _be5.width,
                height: _be5.height,
                originalValue: _be5.originalValue,
                disabled: _be5.disabled,
                readonly: _be5.readonly
            });
        }, cloneFrom: function (jq, from) {
            return jq.each(function () {
                $(this).combo("cloneFrom", from);
    ...
    $.fn.datebox.defaults = $.extend({}, $.fn.combo.defaults, {
        panelWidth: 180, panelHeight: "auto", sharedCalendar: null, keyHandler: {
            ...
            text: function (_bea) {
                ...
                $(_beb).datebox("calendar").calendar({
                    year: _bec.getFullYear(),
                    month: _bec.getMonth() + 1,
                    current: _bec
                });
...
(function ($) {
    function _bef(_bf0) {
        ...
        $(_bf0).datebox("calendar").calendar({
            onSelect: function (date) {
    ...
    $.fn.datetimebox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "datetimebox").options, {
                originalValue: _c05.originalValue,
                disabled: _c05.disabled,
                readonly: _c05.readonly
            });
        }, cloneFrom: function (jq, from) {
            return jq.each(function () {
...
(function ($) {
    ...
    function _c26(_c27) {
        ...
        _c29.find("a.slider-handle").draggable({
    ...
    $.fn.slider = function (_c48, _c49) {
        ...
        return this.each(function () {
            ...
            if (_c4a) {
                ...
                _c4a = $.data(this, "slider", {
                    options: $.extend({}, $.fn.slider.defaults, $.fn.slider.parseOptions(this), _c48),
                    slider: init(this)
                });
                $(this).removeAttr("disabled");
            }
    ...
    $.fn.slider.parseOptions = function (_c4e) {
        var t = $(_c4e);
        return $.extend({}, $.parser.parseOptions(_c4e, ["width", "height", "mode", {
            reversed: "boolean",
            showTip: "boolean",
            range: "boolean",
            min: "number",
    ...
    $.fn.slider.defaults = {
        ...
        step: 1,
        rule: [],
        tipFormatter: function (_c4f) {
            return _c4f;
        },
        converter: {
            toPosition: function (_c50, size) {
                var opts = $(this).slider("options");
